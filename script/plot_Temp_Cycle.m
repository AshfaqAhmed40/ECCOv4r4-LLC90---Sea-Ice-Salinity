...
clear FramStrait_year BarentsSea_year BeaufortGyre_year
%% Plot temperature cycle
figure(1), close all;
...
title(sprintf('Mean temperature upto  %.2f m deep',Z(L))); 
ylabel('Temperature (°C)');ylim([-3 3])
